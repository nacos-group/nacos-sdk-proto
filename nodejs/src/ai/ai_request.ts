 ...
 */
export interface AgentDiscoveryNotifyRequest {
  requestId: string;
  watchKey: string;
  eventType: string;
 ...
 */
export interface AgentSubscribeRpcRequest {
  requestId: string;
  clientWatchId: string;
  discoveryRequest: AgentDiscoveryRequest | undefined;
 ...
 */
export interface AgentUnsubscribeRpcRequest {
  requestId: string;
  watchKey: string;
}
 ...
 */
export interface AiResourceChangeClusterRequest {
  requestId: string;
  namespaceId: string;
  resourceType: string;
  resourceName: string;
...
function createBaseAgentDiscoveryNotifyRequest(): AgentDiscoveryNotifyRequest {
  return { requestId: "", watchKey: "", eventType: "", observedFingerprint: "", errorCode: 0 };
}

export const AgentDiscoveryNotifyRequest: MessageFns<AgentDiscoveryNotifyRequest> = {
  fromJSON(object: any): AgentDiscoveryNotifyRequest {
    return {
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
      watchKey: isSet(object.watchKey) ? globalThis.String(object.watchKey) : "",
      eventType: isSet(object.eventType) ? globalThis.String(object.eventType) : "",
      observedFingerprint: isSet(object.observedFingerprint) ? globalThis.String(object.observedFingerprint) : "",
      errorCode: isSet(object.errorCode) ? globalThis.Number(object.errorCode) : 0,
    };
  },

  toJSON(message: AgentDiscoveryNotifyRequest): unknown {
    const obj: any = {};
    if (message.requestId !== "") {
      obj.requestId = message.requestId;
    }
    if (message.watchKey !== "") {
      obj.watchKey = message.watchKey;
    }
    if (message.eventType !== "") {
      obj.eventType = message.eventType;
    }
    if (message.observedFingerprint !== "") {
      obj.observedFingerprint = message.observedFingerprint;
    }
  ...
  create<I extends Exact<DeepPartial<AgentDiscoveryNotifyRequest>, I>>(base?: I): AgentDiscoveryNotifyRequest {
    return AgentDiscoveryNotifyRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AgentDiscoveryNotifyRequest>, I>>(object: I): AgentDiscoveryNotifyRequest {
    const message = createBaseAgentDiscoveryNotifyRequest();
    message.requestId = object.requestId ?? "";
    message.watchKey = object.watchKey ?? "";
    message.eventType = object.eventType ?? "";
    message.observedFingerprint = object.observedFingerprint ?? "";
...
function createBaseAgentSubscribeRpcRequest(): AgentSubscribeRpcRequest {
  return { requestId: "", clientWatchId: "", discoveryRequest: undefined, materializedFingerprint: "" };
}

export const AgentSubscribeRpcRequest: MessageFns<AgentSubscribeRpcRequest> = {
  fromJSON(object: any): AgentSubscribeRpcRequest {
    return {
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
      clientWatchId: isSet(object.clientWatchId) ? globalThis.String(object.clientWatchId) : "",
      discoveryRequest: isSet(object.discoveryRequest)
        ? AgentDiscoveryRequest.fromJSON(object.discoveryRequest)
        : undefined,
      materializedFingerprint: isSet(object.materializedFingerprint)
        ? globalThis.String(object.materializedFingerprint)
        : "",
    };
  },

  toJSON(message: AgentSubscribeRpcRequest): unknown {
    const obj: any = {};
    if (message.requestId !== "") {
      obj.requestId = message.requestId;
    }
    if (message.clientWatchId !== "") {
      obj.clientWatchId = message.clientWatchId;
    }
    if (message.discoveryRequest !== undefined) {
      obj.discoveryRequest = AgentDiscoveryRequest.toJSON(message.discoveryRequest);
    }
    if (message.materializedFingerprint !== "") {
      obj.materializedFingerprint = message.materializedFingerprint;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<AgentSubscribeRpcRequest>, I>>(base?: I): AgentSubscribeRpcRequest {
    return AgentSubscribeRpcRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AgentSubscribeRpcRequest>, I>>(object: I): AgentSubscribeRpcRequest {
    const message = createBaseAgentSubscribeRpcRequest();
    message.requestId = object.requestId ?? "";
    message.clientWatchId = object.clientWatchId ?? "";
    message.discoveryRequest = (object.discoveryRequest !== undefined && object.discoveryRequest !== null)
      ? AgentDiscoveryRequest.fromPartial(object.discoveryRequest)
      : undefined;
    message.materializedFingerprint = object.materializedFingerprint ?? "";
    return message;
  },
};

function createBaseAgentUnsubscribeRpcRequest(): AgentUnsubscribeRpcRequest {
  return { requestId: "", watchKey: "" };
}

export const AgentUnsubscribeRpcRequest: MessageFns<AgentUnsubscribeRpcRequest> = {
  fromJSON(object: any): AgentUnsubscribeRpcRequest {
    return {
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
      watchKey: isSet(object.watchKey) ? globalThis.String(object.watchKey) : "",
    };
  ...
  toJSON(message: AgentUnsubscribeRpcRequest): unknown {
    const obj: any = {};
    if (message.requestId !== "") {
      obj.requestId = message.requestId;
    }
  ...
  create<I extends Exact<DeepPartial<AgentUnsubscribeRpcRequest>, I>>(base?: I): AgentUnsubscribeRpcRequest {
    return AgentUnsubscribeRpcRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AgentUnsubscribeRpcRequest>, I>>(object: I): AgentUnsubscribeRpcRequest {
    const message = createBaseAgentUnsubscribeRpcRequest();
    message.requestId = object.requestId ?? "";
    message.watchKey = object.watchKey ?? "";
    return message;
  },
...
function createBaseAiResourceChangeClusterRequest(): AiResourceChangeClusterRequest {
  return { requestId: "", namespaceId: "", resourceType: "", resourceName: "", operation: "", storageChanged: false };
}

export const AiResourceChangeClusterRequest: MessageFns<AiResourceChangeClusterRequest> = {
  fromJSON(object: any): AiResourceChangeClusterRequest {
    return {
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
      namespaceId: isSet(object.namespaceId) ? globalThis.String(object.namespaceId) : "",
      ...
      storageChanged: isSet(object.storageChanged) ? globalThis.Boolean(object.storageChanged) : false,
    };
  },

  toJSON(message: AiResourceChangeClusterRequest): unknown {
    const obj: any = {};
    if (message.requestId !== "") {
      obj.requestId = message.requestId;
    }
    ...
    if (message.storageChanged !== false) {
      obj.storageChanged = message.storageChanged;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<AiResourceChangeClusterRequest>, I>>(base?: I): AiResourceChangeClusterRequest {
    return AiResourceChangeClusterRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AiResourceChangeClusterRequest>, I>>(
    object: I,
  ): AiResourceChangeClusterRequest {
    const message = createBaseAiResourceChangeClusterRequest();
    message.requestId = object.requestId ?? "";
    message.namespaceId = object.namespaceId ?? "";
    message.resourceType = object.resourceType ?? "";
    message.resourceName = object.resourceName ?? "";
    message.operation = object.operation ?? "";
    message.storageChanged = object.storageChanged ?? false;
    return message;
  },
};
...
export const ReleaseMcpServerRequest: MessageFns<ReleaseMcpServerRequest> = {
  fromJSON(object: any): ReleaseMcpServerRequest {
    return {
      ...
      endpointSpecification: isSet(object.endpointSpecification)
        ...
        : undefined,
      createDraft: isSet(object.createDraft) ? globalThis.Boolean(object.createDraft) : false,
    };
  },
  ...
  toJSON(message: ReleaseMcpServerRequest): unknown {
    ...
    if (message.createDraft !== false) {
      obj.createDraft = message.createDraft;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ReleaseMcpServerRequest>, I>>(object: I): ReleaseMcpServerRequest {
    ...
    message.endpointSpecification =
      (object.endpointSpecification !== undefined && object.endpointSpecification !== null)
        ...
        : undefined;
    message.createDraft = object.createDraft ?? false;
    return message;
  },
};
