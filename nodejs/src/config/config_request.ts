...
function createBaseConfigChangeClusterSyncRequest(): ConfigChangeClusterSyncRequest {
  return { requestId: "", dataId: "", group: "", tenant: "", lastModified: 0, grayName: "", beta: false, tag: "" };
}
...
function createBaseConfigFuzzyWatchRequest(): ConfigFuzzyWatchRequest {
  return { requestId: "", groupKeyPattern: "", receivedGroupKeys: [], watchType: "", initializing: false };
}
